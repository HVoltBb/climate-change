...
# Model fitting ----
pickone = 1 # Pick a set of inital values to start with
...
obj = TMB::MakeADFun(
  ...
  parameters  = list( c = c(240, 60.6)[pickone],
                      b = 0,
  ...
  DLL = 'v5',
  silent = TRUE # You may want to change it to FALSE to check for errors
)
